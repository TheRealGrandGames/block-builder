document.addEventListener('DOMContentLoaded', () => {
    ...
    const blockCategories = {
        Natural: [
            ...
            { name: 'Suspicious Gravel', texture: 'textures/suspicious_gravel.png' },
            { name: 'Sand', texture: 'textures/sand.png' },
            { name: 'Suspicious Sand', texture: 'textures/suspicious_sand.png' },
        ...
        Stone: [
            ...
            { name: 'Reinforced Deepslate', texture: 'textures/reinforced_deepslate.png' },
